...
def stratified_k_fold_cross_validation(audio_datas: np.ndarray, audio_labels: np.ndarray, n_splits: int = 5):
    ...
    for idx, (train_index, test_index) in enumerate(skf.split(audio_datas, labels_encoded)):
        ...
        # TODO: do training
